...
//		canvas.drawCircle(x, y, radius, paint);  //////////¿ªÊ¼»­Ô²
		canvas.drawCircle((float) (0.5*getWidth()), (float) (0.5*getHeight()), radius, paint);
		
		if (radius > getHeight() / rippleSize)
			radius += rippleSpeed;
		if (radius >= 0.7*(getWidth()>getHeight() ? getHeight():getWidth())) {//////////////////////////////////Ô²µÄ°ë¾¶
			x = -1;
			y = -1;
			radius = getHeight() / rippleSize;
